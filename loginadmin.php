    ...
    <body>
        <div style="text-align:center; margin-top: 30px;">
            ...
            <h2>Login Page</h2>
                ...
                <div id="rcorners2">
                    <label>
                        <input type="text" class="input" autocomplete = "off" placeholder="Enter ID Admin" name="IDAdmin" pattern="[A]{1}[0-9]{1,2}" 
                        title="ID Admin must begin with 'A' and not exceed 2 digits number" maxlength="3" required></input><br>
                        <div class="line-box">         
                            <div class="line"></div>                            
                        </div> 
                    </label>   
                    <label> 
                        <input type="password" class="input" autocomplete = "off" placeholder="Enter password" name="passwordAdmin" required></input><br>
                        <div class="line-box">         
                            <div class="line"></div>                            
                        </div> 
                    </label>
                    <button name = "loginAdmin">Log Masuk</button>                    
                </div>
                <br><br><br>
            </form>               
        </div>
